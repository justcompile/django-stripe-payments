    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('key', models.CharField(unique=True, max_length=20, db_index=True)),
                ('stripe_plan_id', models.CharField(db_index=True, max_length=50, unique=True, null=True, blank=True)),
        ...
        migrations.AddField(
            ...
            name='plan',
            field=models.ForeignKey(to='payments.PaymentPlan', blank=True),
        ...
        migrations.AddField(
            model_name='currentsubscription',
            name='plan',
            field=models.ForeignKey(blank=True, to='payments.PaymentPlan', null=True),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='charge',
